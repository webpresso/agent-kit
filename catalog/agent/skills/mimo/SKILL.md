...
- Primary: `opencode-go/mimo-v2.5-pro`
- Fallbacks: `opencode-go/mimo-v2.5`, `opencode-go/mimo-v2-pro`, `opencode-go/mimo-v2-omni`
...
```bash
opencode run --model opencode-go/mimo-v2.5-pro --dir "$PWD" "$(cat "$PROMPT_FILE")"
```
