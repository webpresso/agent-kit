...
Private workspace package for Webpresso-owned, curated workflow skills derived from MIT-licensed gstack ideas.

This package is intentionally **not publishable**. It holds:

- small Markdown skill sources under `skills/`
- provenance and notice files documenting the upstream source
