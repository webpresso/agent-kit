...
const bunSqliteAlias = [
  {
    find: /^bun:sqlite$/,
    replacement: fileURLToPath(new URL('../../src/__mocks__/bun-sqlite.js', import.meta.url)),
  },
] as const
...
export function createWebpressoNodeProjects(
  name: string,
  options: CreateWebpressoNodeProjectsOptions = {},
): UserWorkspaceConfig[] {
  ...
  } as unknown as UserWorkspaceConfig['server']
