...
describe("executeBlueprintSubcommand", () => {
  ...
  it('routes "new" with goal args', async () => {
    const created: CreateBlueprintResult = {
      ...
      title: "My Feature",
      complexity: "M",
      path: "/tmp/my-feature.md",
      outputPath: "/tmp/my-feature.md",
      projectRoot: "/tmp",
      relativeFilePath: "blueprints/draft/my-feature.md",
      markdown: "# My Feature\n",
      status: "draft",
      blueprint: {
        tasks: [],
  ...
  it("passes --type parent-roadmap for new", async () => {
    const created: CreateBlueprintResult = {
      ...
      title: "Roadmap A",
      complexity: "M",
      path: "/tmp/roadmap-a.md",
      outputPath: "/tmp/roadmap-a.md",
      projectRoot: "/tmp",
      relativeFilePath: "blueprints/draft/roadmap-a.md",
      markdown: "# Roadmap A\n",
      status: "draft",
      blueprint: {
        tasks: [],
