...
describe('auditGitignoreAgentSurfaces', () => {
  ...
  it('protects Stryker mutation artifacts generated by local setup', () => {
    expect(EXPECTED_PATHS).toContain('.stryker-tmp/')
    expect(EXPECTED_PATHS).toContain('reports/mutation/')
    expect(EXPECTED_PATHS).toContain('reports/stryker-incremental.json')
    expect(EXPECTED_PATHS).toContain('stryker-setup-*.js')
  })
})
