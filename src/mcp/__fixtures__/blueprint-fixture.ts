...
function buildOverviewContent(title: string, tasks: BlueprintFixtureSpec["tasks"]): string {
...
export async function buildBlueprintFixture(spec: BlueprintFixtureSpec): Promise<BlueprintFixture> {
