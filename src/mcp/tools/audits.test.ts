...
const blueprintTrustMock = {
  auditBlueprintTrust: vi.fn(),
};
...
const noMathRandomMock = {
  auditNoMathRandom: vi.fn(),
};
...
const supportedAgentClisMock = {
  auditSupportedAgentClis: vi.fn(),
};
...
const atomicStateWritesMock = {
  auditAtomicStateWrites: vi.fn(),
};
...
vi.mock("#audit/blueprint-trust", () => blueprintTrustMock);
...
vi.mock("#audit/no-math-random", () => noMathRandomMock);
...
vi.mock("#audit/supported-agent-clis", () => supportedAgentClisMock);
vi.mock("#audit/session-memory-hardcut", () => sessionMemoryHardcutMock);
vi.mock("#audit/ai-contracts", () => aiContractsMock);
vi.mock("#audit/atomic-state-writes", () => atomicStateWritesMock);
...
describe("wp_audits tool", () => {
  ...
  it("resolves guardrails preset to the bounded repo guardrail audit set", async () => {
    ...
    blueprintTrustMock.auditBlueprintTrust.mockReturnValue(passingAudit());
    ...
    supportedAgentClisMock.auditSupportedAgentClis.mockReturnValue(passingAudit());
    ...
    noMathRandomMock.auditNoMathRandom.mockReturnValue(passingAudit());
    ...
    atomicStateWritesMock.auditAtomicStateWrites.mockReturnValue(passingAudit());
