...
Evidence: docs/bench/reference-parity-matrix.md, src/__integration__/reference-parity-host-smoke.integration.test.ts, src/__integration__/reference-parity-tool-surface.integration.test.ts, docs/bench/session-memory-methodology.md
