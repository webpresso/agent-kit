...
Add a shared Playwright quality-scaffold config surface so consumers can stop committing duplicate generic smoke scaffold files, and publish TypeScript-compatible tsconfig JSON exports for current consumers.
