...
| **Reusable deploy shells** | Shared GitHub workflow shells for Cloudflare preview/prod deploys, while caller repos keep repo-local verify/deploy/smoke logic | [`.github/workflows/cloudflare-preview.yml`](.github/workflows/cloudflare-preview.yml), [`.github/workflows/cloudflare-production.yml`](.github/workflows/cloudflare-production.yml), [`docs/reusable-cloudflare-deploy-workflows.md`](docs/reusable-cloudflare-deploy-workflows.md) |
