...
function makeEval(name, description, assertFn, subagentFn) {
    ...
    return {
        ...
        async run() {
            ...
            const task = { id: name, description, permissions: 'workspace-write' };
...
// ---------------------------------------------------------------------------
function builtinEvals(subagentFn) {
    return [
...
// ---------------------------------------------------------------------------
export async function runAllEvals(subagentFn) {
