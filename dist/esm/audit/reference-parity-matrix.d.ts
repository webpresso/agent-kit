...
export declare const REQUIRED_REFERENCE_PARITY_CAPABILITIES: readonly ["lifecycle capture", "resume injection", "tool discovery", "indexed search", "host setup smoke", "benchmark thresholds", "release claim gating"];
