...
export function createPackedManifest(manifest, workspaceCatalogs, options = {}) {
    ...
    if (includeRuntimeOptionalDependencies && typeof manifest.version === 'string') {
        packedManifest.optionalDependencies = {
            ...
            ...Object.fromEntries(SESSION_MEMORY_NATIVE_TARGETS.map((target) => [
                target.packageName,
                manifest.version,
            ])),
        };
...
export function preparePackedManifest(rootDir, options = {}) {
