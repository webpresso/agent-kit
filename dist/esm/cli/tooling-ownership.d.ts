...
export declare const MANAGED_TOOL_NAMES: readonly ["codex", "claude-code", "opencode", "omx", "omc", "openagent"];
...
export declare function clearUserOwnedTool(state: ToolingOwnershipState, tool: ManagedToolName): ToolingOwnershipState;
