 ...
 */
declare const SUPPORTED_COMMANDS: readonly ["blueprint", "browser", "config", "secrets", "roadmap", "sync", "audit", "qa", "compile", "rule", "skill", "skills", "docs", "setup", "init", "dev", "deploy", "preview", "cleanup", "migrate", "secrets", "doctor", "err", "test", "e2e", "ci", "typecheck", "lint", "format", "logs", "tech-debt", "worktree", "mcp", "hook", "hooks", "gain", "bench", "install", "add", "remove", "update", "exec", "run"];
