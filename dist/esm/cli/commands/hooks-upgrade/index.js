...
import { disableManagedHooksFromManifest, resolveNodeBinaryForManagedHookLaunchers, scaffoldAgentHooks, trustCodexWebpressoHooksForRepo, } from '#cli/commands/init/scaffolders/agent-hooks/index.js';
...
export async function upgradeHooksForRepo(repoRoot, options) {
    ...
    if (options.apply) {
        ...
        normalizeGlobalCodexHooksFile(path.join(repoRoot, '.codex', 'hooks.json'), {
