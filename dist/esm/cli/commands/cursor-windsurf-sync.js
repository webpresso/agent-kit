...
export function registerCursorWindsurfSyncCommand(cli) {
    cli
        .command('cursor-windsurf-sync', 'Copy agent-kit skills to .cursor/rules/ and .windsurf/skills/')
        .action(async () => {
...
//# sourceMappingURL=cursor-windsurf-sync.js.map