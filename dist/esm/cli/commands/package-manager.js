...
const HELP_BY_VERB = {
    ...
    update: 'Refresh wp and any optional OMX/OMC/gstack integrations previously installed by wp; use --deps for local dependency updates through the managed package/task facade.',
