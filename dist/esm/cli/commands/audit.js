...
export function registerAuditCommand(cli) {
    cli
        .command('audit <kind> [target]', 'Run a packaged audit (tph, tph-e2e, bundle-budget, catalog-drift, commit-message, docs-frontmatter, blueprint-lifecycle, tech-debt)')
        ...
        switch (kind) {
            ...
            default: {
                console.error(`Unknown audit kind: ${kind}. Use 'tph', 'tph-e2e', 'bundle-budget', 'catalog-drift', 'commit-message', 'docs-frontmatter', 'blueprint-lifecycle', or 'tech-debt'.`);
                process.exit(1);
            }
        }
    });
