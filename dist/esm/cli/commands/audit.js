...
const REPO_AUDIT_REGISTRY = {
    ...
    'blueprint-lifecycle': async (root, options) => (await import('#audit/repo-guardrails')).auditBlueprintLifecycle(root, {
 ...
 */
async function runRepoGuardrailsGate(root, options) {
