...
import { type GlobalCapableVpCommandInput } from '#cli/commands/init/scaffolders/vp-global.js';
...
export declare function repairInstalledOmxPluginHooks(codexHome: string, nodeBinary: string): string[];
/**
