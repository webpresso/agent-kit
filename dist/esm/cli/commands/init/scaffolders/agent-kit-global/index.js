...
const NO_VP_HINT = "the bundled Vite+ runner is unavailable; cannot refresh the global " +
...
export function ensureAgentKitGlobal(input) {
    ...
    const isSupportedGlobalInstall = argv1.length > 0 && (input.confirmInstalledGlobally ?? confirmInstalledGlobally)(argv1, env);
