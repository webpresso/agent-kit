...
export declare function resolveSourceRepoHookLauncher(repoRoot: string, options?: {
 ...
 */
export declare function extractWebpressoHookBinName(command: string): string | null;
/**
...
export declare function buildManagedHooksManifest(repoRoot: string, vendorState?: HookVendorStateMap): HooksManifest;
...
export declare function restoreManagedHooksFromManifest(input: ScaffoldAgentHooksInput, _manifest: HooksManifest, vendors?: readonly ManagedHookVendor[]): ManagedHookMutationResult;
