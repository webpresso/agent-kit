...
export const CAPABILITY_MATRIX = [
    ...
    },
    {
        ...
        cursor: 'unmapped',
        opencode: 'partial',
        notes: 'Cursor: not mapped in third-party compat table. OpenCode: permission.asked/replied exist but no deny-envelope parity with Claude/Codex. Current managed wp-* surface does not install a dedicated permission hook',
    },
    {
        event: 'SubagentStart',
        claude: 'partial',
    ...
    },
    {
        ...
        cursor: 'unsupported',
        opencode: 'partial',
        notes: 'Accepted in lifecycle tooling, but the current managed wp-* surface does not install a dedicated pre-compact hook. OpenCode experimental.session.compacting fires before compaction',
    },
    {
        event: 'PostCompact',
        claude: 'partial',
