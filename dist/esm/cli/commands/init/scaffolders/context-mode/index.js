...
function resolveOpenCodeAgentKitCommand(repoRoot) {
...
export function ensureContextMode(input) {
    ...
    return {
        ...
        opencodeConfig: patchJsonFile(opencodeConfigPath, (existing) => patchOpenCodeContextModeConfig(existing, resolveOpenCodeAgentKitCommand(input.repoRoot)), input.options),
        installed,
    };
}
