...
export declare function getRepairCommandName(commandName: InitCommandName): `${InitCommandName}-repair`;
...
export declare function validatePrimarySetupArgv(commandName: InitCommandName, args: readonly string[]): string | null;
