...
export declare const SHARED_FAVORITE_SKILLS: readonly ["fix", "verify", "testing-philosophy", "plan-refine", "pll", "best-practice-research"];
export declare const TIER1_SKILLS: readonly ["fix", "verify", "testing-philosophy", "plan-refine", "pll", "best-practice-research"];
