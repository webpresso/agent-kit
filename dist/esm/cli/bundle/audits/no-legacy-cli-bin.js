...
const DEFAULT_SCAN_TARGETS = ['apps', 'packages', '.github'];
...
function collectLegacyCliBinFindings(repoRoot) {
    const findings = [];
...
export function runNoLegacyCliBinAudit(repoRoot = process.cwd()) {
