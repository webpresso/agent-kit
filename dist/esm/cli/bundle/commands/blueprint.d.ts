...
export declare const blueprintCommands: {
    ...
    move: CliCommand<Record<string, unknown>>;
    new: CliCommand<Record<string, unknown>>;
    park: CliCommand<Record<string, unknown>>;
    show: CliCommand<Record<string, unknown>>;
    start: CliCommand<Record<string, unknown>>;
    task: CliCommand<Record<string, unknown>>;
};
