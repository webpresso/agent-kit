...
const SCOPE = 'Agent';
function command(name, description, run) {
    return {
...
export const agentCommands = {
    audit: placeholderGroup(SCOPE, 'audit', 'Run packaged audits', {
        'blueprint-lifecycle': placeholderCommand(SCOPE, 'blueprint-lifecycle', 'Audit blueprint lifecycle state'),
        'bucket-boundary': placeholderCommand(SCOPE, 'bucket-boundary', 'Audit package bucket boundaries'),
        ...
        'commit-message': placeholderCommand(SCOPE, 'commit-message', 'Audit commit messages for Lore compliance'),
        'docs-frontmatter': placeholderCommand(SCOPE, 'docs-frontmatter', 'Audit docs frontmatter contracts'),
        mutation: placeholderCommand(SCOPE, 'mutation', 'Run mutation testing audits'),
        'no-legacy-cli-bin': command('no-legacy-cli-bin', 'Audit for active legacy CLI bin invocations', () => runNoLegacyCliBinAudit()),
        'no-relative-parent-imports': placeholderCommand(SCOPE, 'no-relative-parent-imports', 'Audit for parent-relative imports'),
    ...
    e2e: placeholderCommand(SCOPE, 'e2e', 'Build and run E2E commands through the portable agent surface'),
