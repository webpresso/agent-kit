...
import { SECRET_SINK_NAMES, } from "#secrets/sinks/types.js";
const RUNTIME_PROFILE_BY_SINK = {
...
export function resolveSecretSink(schemaOrInput, maybeInput) {
    ...
    if (!sink || !SECRET_SINK_NAMES.includes(input.sink)) {
    ...
    return {
        ...
        runtimeProfile: RUNTIME_PROFILE_BY_SINK[input.sink],
