export declare const BUILT_IN_PROVIDER_TYPES: readonly ["doppler", "infisical"];
export declare const BUILTIN_SECRET_PROVIDER_TYPES: readonly ["doppler", "infisical"];
...
export interface SecretProviderPlugin {
    ...
    fetchProfile(input: ProviderProfileFetchInput): Promise<ResolvedSecretMaterial> | ResolvedSecretMaterial;
    planBootstrap?(input: ProviderBootstrapInput): Promise<ProviderBootstrapPlan> | ProviderBootstrapPlan;
}
