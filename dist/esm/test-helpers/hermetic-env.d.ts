 ...
 */
export declare const LEAKY_ENV_KEYS: readonly ["CLAUDE_PROJECT_DIR", "WP_SKIP_UPDATE_CHECK", "WP_BLUEPRINT_ROOTS_TIMEOUT_MS", "WP_BLUEPRINT_PROJECT_DISCOVERY_TIMEOUT_MS", "WP_BLUEPRINT_PLATFORM_DISABLED", "WP_MCP_TOOL_MODE", "WP_COMPILED_RUNTIME", "GITHUB_PAT", "QUALITY_ENGINE_COMPACT", "GIT_DIR", "GIT_WORK_TREE", "GIT_INDEX_FILE"];
