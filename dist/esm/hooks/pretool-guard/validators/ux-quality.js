...
export function validateUxQuality(input) {
    if (process.env.UX_QUALITY_SKIP === "1") {
        return createSkipResult(VALIDATOR_NAME, "Bypass enabled via UX_QUALITY_SKIP=1 — exceptional cases only; restore UX guardrails immediately after the bypass run");
    }
