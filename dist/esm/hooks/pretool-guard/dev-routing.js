...
function routeRawMutatingGitWorktree(command) {
    ...
    return {
        action: 'deny',
        tool: 'wp_worktree',
        guidance: 'Use `wp worktree` instead — managed repositories may mutate linked worktrees only through agent-kit so owner bindings and the global registry stay consistent.',
    };
}
const ROUTING_RULES = [
    {
