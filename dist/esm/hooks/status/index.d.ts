...
export declare function deriveHookConfigSourceStatus(repoRoot: string, homePath?: string): readonly HookConfigSourceStatusLine[];
export declare function formatHookConfigSourceLine(input: {
    readonly vendor: "claude" | "codex";
    readonly filePath: string;
    readonly repoRoot: string;
    readonly hooks: number;
}): string;
export declare function formatHookConfigSourceStatusLine(source: HookConfigSourceStatusLine): string;
