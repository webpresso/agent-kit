 ...
 */
export function sharedOxlintConfigArgs(cwd, existingArgs) {
    if (existingArgs.includes("--config") || existingArgs.includes("-c"))
        return [];
    if (hasLocalOxlintConfig(cwd))
        return [];
    const shared = resolveSharedOxlintConfigPath();
    return shared ? ["--config", shared] : [];
}
//# sourceMappingURL=shared-config-path.js.map