...
const tool = {
    ...
    description: "Report bounded local diagnostics for session-memory continuity and index stores. Use for diagnosing session-memory stores, locks, corruption, repair hints; run `wp session doctor` directly only if this tool is unavailable.",
    inputSchema,
    outputSchema,
    annotations: {
