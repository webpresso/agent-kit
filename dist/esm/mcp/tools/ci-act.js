import { z } from 'zod';
import { normalizeActSecretsWithOptions, resolveCiActSecretProfile, listMissingRequiredSecrets, pickAllowedSecrets, writeTempSecretsFile, } from '#ci/act-helper.js';
...
function buildInternalActCommandArgs(input, secretsPath) {
    return [...buildPublicCiActArgs(input), '--secret-file', secretsPath];
}
function publicCommandDetails(input, secretsPath) {
