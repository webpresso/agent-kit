...
const tool = {
    ...
    description: 'Run multiple shell commands through session-memory execution, using the native backend when available and TypeScript fallback otherwise; optionally search indexed results.',
    inputSchema,
    outputSchema,
    annotations: {
