...
const tool = {
    ...
    description: "Report bounded local session-memory continuity and index counts. Use for read-only session-memory counts and source diagnostics; run `wp session stats` directly only if this tool is unavailable.",
    inputSchema,
    outputSchema,
    annotations: {
        title: "Session stats",
