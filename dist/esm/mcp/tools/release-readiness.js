...
const tool = {
    ...
    description: "Aggregate read-only release readiness checks without publishing, tagging, versioning, merging, or mutating release state. Use for release readiness / package surface / changeset status (read-only); run `wp release readiness` directly only if this tool is unavailable.",
    inputSchema,
    outputSchema,
    annotations: {
