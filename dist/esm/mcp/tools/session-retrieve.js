...
const tool = {
    ...
    description: 'Retrieve exact session-memory elided content by id. Use this when an elision handle is present; use search for content lookup and restore for broader continuity.',
    inputSchema,
    outputSchema,
    annotations: {
