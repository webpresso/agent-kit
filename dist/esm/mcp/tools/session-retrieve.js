...
const tool = {
    ...
    description: "Retrieve exact session-memory elided content by id. Use this when an elision handle is present; use search for content lookup and restore for broader continuity. Use for retrieving exact elided/truncated content by handle id; run `wp session retrieve` directly only if this tool is unavailable.",
    inputSchema,
    outputSchema,
    annotations: {
...
export default tool;
//# sourceMappingURL=session-retrieve.js.map