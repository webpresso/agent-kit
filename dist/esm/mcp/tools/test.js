...
const tool = {
    name: "wp_test",
    description: "Run tests via the `vp` package-manager facade. Use `wp_e2e` for suite-aware E2E execution. Use for running tests / verifying the suite; prefer over raw vitest or bun run test; run `wp test` directly only if this tool is unavailable.",
    inputSchema,
    outputSchema,
