...
const tool = {
    ...
    description: 'Run one shell command through session-memory execution, using the native backend when available and TypeScript fallback otherwise; index output for search.',
    inputSchema,
    outputSchema,
    annotations: {
...
export default tool;
//# sourceMappingURL=_session-execute.js.map