 ...
 */
import { ALLOWED_REAL_FILES, type ConsumerConfig, DEFAULT_CONSUMERS, DEFAULT_SKILLS_CONSUMERS, type SkillsConsumerConfig } from './consumers.js';
export interface PerSkillConsumerConfig {
    dir: string;
}
export declare const DEFAULT_PER_SKILL_CONSUMERS: PerSkillConsumerConfig[];
export { ALLOWED_REAL_FILES, type ConsumerConfig, DEFAULT_CONSUMERS, DEFAULT_SKILLS_CONSUMERS, type SkillsConsumerConfig, };
