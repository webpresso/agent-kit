...
import { buildRuntimeProcessEnv, createRuntimeEnvCache, resolveRuntimeEnvironment, } from '#runtime/index.js';
...
async function runDeployStep(step, plan, cache) {
...
async function runHttpCheck(step, cache) {
    const cwd = step.cwd ?? process.cwd();
