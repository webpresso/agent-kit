...
// ../agent-kit/src/hooks/guard-switch/index.ts
runHook(
  (input) => {
    const normalized = (input.prompt ?? "").toLowerCase().trim();
    if (normalized === "guard off") {
      setGuardEnabled(false);
      console.error("\u{1F6E1}\uFE0F Guard disabled \u2014 pretool validators will be skipped");
      process.exit(2);
    }
    if (normalized === "guard on") {
      setGuardEnabled(true);
      console.error("\u{1F6E1}\uFE0F Guard enabled \u2014 pretool validators active");
      process.exit(2);
    }
    return null;
  },
