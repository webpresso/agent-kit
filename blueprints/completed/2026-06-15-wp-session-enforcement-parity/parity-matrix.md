...
| agent-kit hook scaffolding    | `src/cli/commands/init/scaffolders/agent-hooks/index.ts` has broad Codex examples (`Bash                                                                                                                                                                                                                                          | apply_patch                                                                  | Edit | Write | mcp\_\_.\*`) but Claude config has historically been edit/shell-heavy. | Host matchers must be host-specific and tested; do not overclaim identical hook semantics. |
