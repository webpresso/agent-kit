...
[{"audit_kind":"blueprint-lifecycle","command":"bun src/cli/cli.ts audit blueprint-lifecycle","kind":"audit","passed":true,"result":"pass","ts":"2026-06-04T08:42:00.000Z"},{"audit_kind":"hook-surface","command":"bun src/cli/cli.ts audit hook-surface","kind":"audit","passed":true,"result":"pass","ts":"2026-06-04T08:42:00.000Z"},{"command":"wp test --file src/audit/blueprint-lifecycle-sql.test.ts --file src/blueprint/db/gc.test.ts --file src/blueprint/db/ingester.test.ts --file src/hooks/pretool-guard/validators/forbidden-commands.test.ts --file src/mcp/blueprint-server.transition.test.ts --file src/blueprint/freshness.test.ts","exit_code":0,"kind":"test","result":"pass","ts":"2026-06-04T08:42:00.000Z"},{"command":"wp test --file src/cli/commands/blueprint/mutations.test.ts","exit_code":0,"kind":"test","result":"pass","ts":"2026-06-04T08:42:00.000Z"},{"command":"wp lint --file src/audit/blueprint-lifecycle-sql.ts --file src/audit/blueprint-lifecycle-sql.test.ts --file src/blueprint/db/gc.ts --file src/blueprint/db/gc.test.ts --file src/blueprint/db/cold-start.ts --file src/blueprint/projection-ready.ts --file src/blueprint/freshness.ts --file src/hooks/pretool-guard/validators/forbidden-commands.ts --file src/hooks/pretool-guard/validators/forbidden-commands.test.ts --file .github/workflows/ci.webpresso.yml --file src/cli/commands/blueprint/mutations.ts --file src/cli/commands/blueprint/mutations.test.ts","exit_code":0,"kind":"test","result":"pass","ts":"2026-06-04T08:42:00.000Z"},{"command":"wp typecheck","exit_code":0,"kind":"test","result":"pass","ts":"2026-06-04T08:42:00.000Z"}]
```
