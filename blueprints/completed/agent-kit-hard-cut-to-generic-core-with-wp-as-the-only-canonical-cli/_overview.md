...
progress: >-
  100% (11/11 tasks done; hard-cut surface, downstream verification, docs,
  tarball checks, and breaking-release contract all completed by 2026-05-29)
depends_on: []
tags:
  - public-package
  - hard-cut
...
| ID | Claim | Evidence |
| -- | ----- | -------- |
| C1 | This executable blueprint has a canonical repository document. | repo:blueprints/completed/agent-kit-hard-cut-to-generic-core-with-wp-as-the-only-canonical-cli/_overview.md |
