...
human-readable history + rejection reasoning worth keeping.
...
**Outcome:** ≥2 distinct approvals (codex + deepseek) on the final rev → eligible for promotion to `planned`.
