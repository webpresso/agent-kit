...
# Subprocess test pool isolation via .subprocess.test.ts suffix + vitest projects

**Goal:** Subprocess test pool isolation via .subprocess.test.ts suffix + vitest projects

## Planning Summary

- Goal input: `Subprocess test pool isolation via .subprocess.test.ts suffix + vitest projects`
- Complexity: `M`
- Draft slug: `subprocess-test-pool-isolation-via-subprocess-test-ts-suffix-vitest-projects`
- Output path: `blueprints/draft/subprocess-test-pool-isolation-via-subprocess-test-ts-suffix-vitest-projects.md`
- Generated command: `wp blueprint new "Subprocess test pool isolation via .subprocess.test.ts suffix + vitest projects" --complexity M`
