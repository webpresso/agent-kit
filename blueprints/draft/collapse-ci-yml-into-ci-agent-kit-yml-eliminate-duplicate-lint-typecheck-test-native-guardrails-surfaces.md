...
# Collapse ci.yml into ci.agent-kit.yml — eliminate duplicate lint/typecheck/test/native/guardrails surfaces

**Goal:** collapse ci.yml into ci.agent-kit.yml — eliminate duplicate lint/typecheck/test/native/guardrails surfaces

## Planning Summary

- Goal input: `collapse ci.yml into ci.agent-kit.yml — eliminate duplicate lint/typecheck/test/native/guardrails surfaces`
- Complexity: `XS`
- Draft slug: `collapse-ci-yml-into-ci-agent-kit-yml-eliminate-duplicate-lint-typecheck-test-native-guardrails-surfaces`
- Output path: `blueprints/draft/collapse-ci-yml-into-ci-agent-kit-yml-eliminate-duplicate-lint-typecheck-test-native-guardrails-surfaces.md`
- Generated command: `wp blueprint new "collapse ci.yml into ci.agent-kit.yml — eliminate duplicate lint/typecheck/test/native/guardrails surfaces" --complexity XS`
