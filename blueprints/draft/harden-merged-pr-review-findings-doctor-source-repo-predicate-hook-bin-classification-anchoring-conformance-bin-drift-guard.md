...
# Harden merged-PR review findings: doctor source-repo predicate, hook-bin classification anchoring, conformance bin drift guard

**Goal:** Harden merged-PR review findings: doctor source-repo predicate, hook-bin classification anchoring, conformance bin drift guard

## Planning Summary

- Goal input: `Harden merged-PR review findings: doctor source-repo predicate, hook-bin classification anchoring, conformance bin drift guard`
- Complexity: `S`
- Draft slug: `harden-merged-pr-review-findings-doctor-source-repo-predicate-hook-bin-classification-anchoring-conformance-bin-drift-guard`
- Output path: `blueprints/draft/harden-merged-pr-review-findings-doctor-source-repo-predicate-hook-bin-classification-anchoring-conformance-bin-drift-guard.md`
- Generated command: `wp blueprint new "Harden merged-PR review findings: doctor source-repo predicate, hook-bin classification anchoring, conformance bin drift guard" --complexity S`
