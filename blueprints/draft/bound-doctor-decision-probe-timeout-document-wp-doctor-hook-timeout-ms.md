...
# Bound doctor decision-probe timeout + document WP_DOCTOR_HOOK_TIMEOUT_MS

**Goal:** Bound doctor decision-probe timeout + document WP_DOCTOR_HOOK_TIMEOUT_MS

## Planning Summary

- Goal input: `Bound doctor decision-probe timeout + document WP_DOCTOR_HOOK_TIMEOUT_MS`
- Complexity: `XS`
- Draft slug: `bound-doctor-decision-probe-timeout-document-wp-doctor-hook-timeout-ms`
- Output path: `blueprints/draft/bound-doctor-decision-probe-timeout-document-wp-doctor-hook-timeout-ms.md`
- Generated command: `wp blueprint new "Bound doctor decision-probe timeout + document WP_DOCTOR_HOOK_TIMEOUT_MS" --complexity XS`
