...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Claude Context7 MCP setup through agent-kit secret provider | [`completed/2026-06-11-claude-context7-secret-provider-mcp-setup.md`](./completed/2026-06-11-claude-context7-secret-provider-mcp-setup.md)                         | `wp setup` writes Claude `.mcp.json` Context7 config with `${CONTEXT7_API_KEY}` headers; current operator guidance is to launch Claude from a provider-backed shell or `wp secrets run ...` flow. |
...
| wp setup repeat-run architecture cleanup                    | [`completed/2026-06-11-wp-setup-repeat-run-architecture.md`](./completed/2026-06-11-wp-setup-repeat-run-architecture.md)                                           | Consecutive setup runs skip cached gstack refreshes by default, expose explicit refresh knobs, and now route source-repo repair through `wp setup repair` / `WP_FORCE_SOURCE=1 wp setup repair`.  |
