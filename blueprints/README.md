...
| ----- | ----: | ----------- |
| `draft/` | 6 | early-stage sketches. Expect churn; move to `planned/` once scoped. |
| `planned/` | 20 | committed-to specs, ready to pick up. |
| `in-progress/` | 0 | actively being executed. At most 3 active blueprints per lane. |
| `completed/` | 74 | execution finished and verified. Kept for reference. |
