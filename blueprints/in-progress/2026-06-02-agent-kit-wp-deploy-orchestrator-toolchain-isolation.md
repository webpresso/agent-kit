...
progress: "Reality check (2026-06-03): managed runners, `deploy.adapterModule`, `wp deploy`, the `toolchain-isolation` audit, and MCP exposure are present in repo. This lane is now closeout/proof work: finish the React preset types follow-up and capture fresh-clone evidence."
...
- edge-matte — `ozby/edge-matte/blueprints/in-progress/2026-06-02-edge-matte-wp-deploy-adapter-toolchain-isolation.md`
- ingest-lens — `ozby/ingest-lens/blueprints/in-progress/2026-06-02-ingest-lens-wp-deploy-adapter-toolchain-isolation.md`
